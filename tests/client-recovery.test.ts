...
function harness(){
  ...
  vm.createContext(c);vm.runInContext(read('history.js'),c);vm.runInContext(read('recovery.js'),c);vm.runInContext(source.slice(source.indexOf('async function selectThread('),source.indexOf('function openStream(')),c);
